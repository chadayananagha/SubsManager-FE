...
const AddSubsForm = ({ closeForm, handleSubmit }) => {
  ...
  return (
    ...
    <motion.div
      ...
      className="z-50 shadow-[0_0_0_10000px_rgba(0,0,0,.40)] absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-base-100 rounded-lg p-6   w-full max-w-md sm:max-w-lg lg:max-w-xl overflow-hidden"
    >
