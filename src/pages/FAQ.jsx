		...
		<div className='mx-3 pt-32'>
			...
			>
				...
				<div className='collapse-content text-white/80'>
					<p>
						By using Share & Subs, you can share subscriptions like Netflix,
						Disney+, NordVPN, Spotify, and others with family or friends. This
			...
			>
				...
				<div className='collapse-content px-8'>
					<ul className='list-disc leading-7 text-white/80'>
						...
						<li>Click the button “Request cancellation”</li>
						<li>
